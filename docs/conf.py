...
html_theme_options = {
    ...
    'extra_nav_links': {
        'invenio-oarepo-files-rest@GitHub': 'https://github.com/oarepo/invenio-oarepo-files-rest',
...
htmlhelp_basename = 'oarepo-files-rest_namedoc'
